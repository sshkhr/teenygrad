...
- [2.1 Sequence Learning with Deep Neural Networks from](#21-learning-sequences-with-deep-neural-networks-in-torch)
[`karpathy/makemore`](https://github.com/karpathy/makemore) [in `pytorch`](#21-learning-sequences-with-deep-neural-networks-in-torch)
  ...
  - [2.1.9 Learning Some Deep Learning Theory]()
