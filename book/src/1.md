...
- [1. Representing *Data* with High Dimensional Stochasticity]()
  ...
  - [1.6 Representing Data Dimensionally with Random Vectors of a Linear Coordinate Space](#16-representing-data-dimensionally-with-random-vectors-of-a-linear-coordinate-space)
  - [1.7 The Geometry of Coordinate Spaces via Inner Products: Lengths, Distances, Angles]()
  - [1.8 Matrix Factorizations: Eigenvalue and Singular Values Decomposition]() <!-- projections -->
  - [1.9 Learning Subspaces from Data with Principal Component Analysis via Maximum Variance...]()
...
### 1.6 Representing Data Dimensionally with Random Vectors of a Linear Coordinate Space
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small>
...
Before we talk about the high dimensional coordinates, let's review the concepts of two and three dimensional coordinates.
Historically speaking, the origin of coordinate systems dates back to
history of extension..

<span class="defnote">**vector $\mathbf{x}$**</span>**vector**<span class="sidenote-number"></span><span class="sidenote">*Grant Sanderson's [3Blue1Brown Essence of Linear Algebra Chapter 1: Vectors](https://www.youtube.com/watch?v=fNk_zzaMoSs)*</span>
$\mathbf{x} \in$ <span class="defnote">**vector space $\mathcal{V}$**</span>**vector space**<span class="sidenote-number"></span><span class="sidenote">*Grant Sanderson's [3Blue1Brown Essence of Linear Algebra Chapter 16: Abstract Vector Spaces](https://www.youtube.com/watch?v=TgKwz5Ikpc8)*</span>
$\mathcal{V}$

<span class="defnote">**euclidean space $\mathbb{E}^d$**</span>**euclidean space**
<span class="defnote">**coordinate space $\reals^d$**</span>**coordinate space**

<span class="defnote">**data matrix $\mathbf{X}$**</span>**data matrix**
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc at viverra neque. Aliquam sed hendrerit nisi, a ultricies dolor. Etiam tellus odio, dignissim quis augue sit amet, ultrices porttitor elit. In rutrum faucibus malesuada. Nam sit amet nisl ac ante dictum ultrices. Nulla id erat consequat, iaculis odio sed, feugiat magna. In orci nulla, facilisis ut egestas eget, pulvinar et risus. Sed a scelerisque dolor, eu mattis lacus. Cras justo lectus, porttitor quis felis ut, molestie semper odio. Phasellus nisl dolor, vulputate id odio id, ornare ultrices mauris. Aliquam erat volutpat. Mauris condimentum, augue sed pellentesque rhoncus, justo sapien dignissim nisi, at congue lectus mauris at sapien.

<!-- - coordinates with vectors (word2vec) -> definition of a vector space (addition, multiply) -->
...
```python
{{#include ../../examples/1.6-vspace.py:1:62}}
```
...
```python
{{#include ../../examples/1.6-vspace.py:62:}}
```

- batched coordinates with design matrices (word2vec) -> independance, basis, dimension
...
- linear transformations (word2vec ->)

### 1.7 The Geometry of Coordinates via Inner Products: Length, Distance, Angle, Projection
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small>
...
### 1.8 Matrix Factorizations: Eigenvalues, Singular Value, and their Decompositions
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small>
