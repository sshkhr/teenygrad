...
- [1. Representing *Data* with High Dimensional Stochasticity]()
  - [1.1 From Software 1.0 to 2.0: Deductively Symbolic ELIZA to Inductively Dimensional GPT](#11-from-software-10-to-20-deductively-symbolic-eliza-to-inductively-dimensional-gpt)
...
### 1.1 From Software 1.0 to 2.0: Deductively Symbolic ELIZA to Inductively Dimensional GPT
...
### 1.5 Representing Data Dimensionally with Random Vectors of a Coordinate Space
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small>

Now that you understand the first difference between how ELIZA and ChatGPT are programmed
— the former specifies *logically deductive instructions* of software 1.0 and the latter recovers
*probabilistically inductive distributions* $p(X_{n+1}=x_{n+1}|X_1=x_1,X_2=x_2,\dots,X_n=x_n)$ of software 2.0 —
we are now ready to learn about the second difference: that of systems using *dimensional* data representations in contrast to *symbolic* ones.
Together, the two differences answer Chapter 1's primary question:
