...
## Table of Contents
- [1.1 Statistical Learning of Continuously Stochastic *Data* with `numpy`](#11-statistical-learning-of-continuously-stochastic-data-with-numpy)
  - [1.1.1 Distributing Truth Stochastically with Probabilities]()
  - [1.1.2 Probabilities of Equally Likely Events with Elementary Combinatorics]()
  - [1.1.3 Probabilities of Events with Rules: Sum Rule, Product Rule, Bayes Rule]()
  - [1.1.4 Representing Types in Higher Dimensions with Coordinates]()
  - [1.1.5 Linear Transformations with Matrix-Vector Multiplication]()
  - [1.1.6 Random Variables with their Distributions, Expectations, and Variance]()
  - [1.1.7 Probabilities from Data with Maximum Likelihood Estimation]()
- [1.2 Statitical Learning of Continuously Stochastic *Functions* with `numpy`](#12-statistical-learning-of-continuously-stochastic-function-with-numpy)
  - [1.2.1 Predicting Scalars with Linear Regression and Mean Squared Error Loss]()
  - [1.2.2 Fitting a Line Directly with Normal Equations]()
  - [1.2.3 Predicting Categories with Logistic Regression and Cross Entropy Loss]()
  - [1.2.4 Fitting a Line Iteratively with Gradient Descent]()
  - [1.2.5 The Fundamental Theorem of Statistical Learning]() <!-- Generalized Linear Models, Generalization, Bias-Variance Tradoff, and Double Descent -->
...
## 1.1 Statistical Learning of Continuously Stochastic *Data* with `numpy`
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>



In this chapter [1.1 Statistical Inference of Continuously Stochastic *Data* with `numpy`](#11-statistical-inference-of-stochastic-data-with-python)
we will cover *continously stochastic data* $\mathbf{x}$<span class="sidenote-number"></span><span class="sidenote">*and in the next chapter [1.2 Statistical Learning of Continuously Stochastic *Functions* with `numpy`](#12-statistical-learning-of-continuously-stochastic-function-with-numpy), we will cover *continuously stochastic functions* $f(\mathbf{x})$.*</span>.
...
## 1.2 Machine Learning of Continuously Stochastic *Function* with `numpy`
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
### 1.2.2 Maximizing Likelihood Implies Mean Squared Error
...
### 1.2.4 Fitting a Line Iteratively with Derivatives of Hilbert Space in Gradient Descent

### 1.2.5 Generalized Linear Models: Linear and Logistic Regression
