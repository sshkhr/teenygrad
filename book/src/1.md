...
## I. Table of Contents
- [**1. Representing *Data* with High Dimensional Stochasticity in `numpy`**](#1-representing-data-with-high-dimensional-stochasticity-in-torch)
  - [**1.1 From Software 1.0 to Software 2.0**](#11-from-software-10-to-software-20) <!-- Propositionally Discrete to  Probabilistically Dimensional -->
  - [**1.2 Distributing Data Stochastically with Probabilities of Probability Spaces**](#12-distributing-words-stochastically-with-probabilities)
  ...
  - [**1.6 Representing Data Dimensionally with Random Vectors of Coordinate Spaces**](#16-representing-data-dimensionally-with-random-vectors-of-coordinate-spaces)
...
- [**2. Learning *Functions* from *Data* with Parameter Estimation in `numpy`**](#2-learning-functions-from-data-with-optimization-in-torch)
  ...
  - [**2.3 Fitting Linear Regression by Directly Optimizing Squared Error**](#23-fitting-linear-regression-by-directly-optimizing-squared-error)
...
- [**3. Accelerating *Functions* and *Data* on `CPU` in `teenygrad` with `rust` and `RISC-V`**](#3-accelerating-functions-and-data-with-basic-linear-algebra-subroutines-in-teenygrad)
  ...
  - [**3.4 Accelerating the BLAS on Multi Core CPUs: Instruction Sets, Pipelines and Hierarchies**](#34-accelerating-the-blas-instruction-sets-pipelines-and-hierarchies)
...
```python
{{#include ../../examples/1.6-spaces.py:5:71}}
```
...
### 3.4 Accelerating the `BLAS`: Instruction Sets, Pipelines and Hierarchies
