...
## I. Table of Contents
- [1. Learning *Distributions* From Data with `pytorch`](#1-learning-distributions-from-data-with-pytorch)
  - [1.1 From Deductive Software 1.0 to Inductive Software 2.0]()
  - [1.2 Distributing Truth Stochastically with Probabilities]()
  - [1.3 Probabilities of Equally Likely Events with Elementary Combinatorics]()
  - [1.4 Probabilities Composed with Sum, Product, and Bayes Rule]()
  - [1.5 Representing Types in Higher Dimensions with Coordinates]()
  - [1.6 Linear Transformations with Matrix-Vector Multiplication]()
  - [1.7 Random Variables with their Distributions, Expectations, and Variance]()
  - [1.8 Probabilities from Data with Parameter Estimation via Maximum Likelihood]()
  - [1.9 Probabilities from Data Redux with Parameter Estimation via Maximum a Posteriori]()
- [2. Learning *Functions* From Data with `pytorch`](#2-learning-functions-from-data-with-pytorch)
  - [2.1 Linearly Modeling Regression by Directly Optimizing Squared Error Loss](#21-linearly-modeling-regression-by-directly-optimizing-squared-error-loss)
  - [2.2 Generalization]()
  - [2.3 Linearly Modeling Classification by Iteratively Optimizing Cross Entropy Loss]()
  - [2.4 ??]() <!-- Generalized Linear Models, Generalization, Bias-Variance Tradoff, and Double Descent -->
- [3. Accelerating *Basic Linear Algebra Subroutines* with `teenygrad.Tensor`](#3-accelerating-basic-linear-algebra-subroutines-with-teenygradtensor)
...
## 1. Learning *Distributions* From Data with `pytorch`
...
then..
- probability 101 (outcomes, events, experiments...)

ending..
- the kolmogorov axiomatization of a probability space
- machine learning is the mechanization of probabilistic inference
- algorithmic information theory: kolmogorov complexity, solomonoff induction
...
In this chapter [1 Statistical Inference of Continuously Stochastic *Data* with `numpy`](#11-statistical-inference-of-stochastic-data-with-python)
we will cover *continuously stochastic data* $\mathbf{x}$<span class="sidenote-number"></span><span class="sidenote">*and in the next chapter [1.2 Statistical Learning of Continuously Stochastic *Functions* with `numpy`](#12-statistical-learning-of-continuously-stochastic-function-with-numpy), we will cover *continuously stochastic functions* $f(\mathbf{x})$.*</span>.
...
In the next three chapters we will place our focus on the transition from deterministic to continuous descriptions with *probabilities* of a *probability space*
  - [1.2 Distributing Truth Stochastically with Probabilities]()
  - [1.3 Probabilities on Equally Likely Events with Elementary Combinatorics]()
  - [1.4 Probabilities on Events with Rules: Sum Rule, Product Rule, Bayes Rule]()

and in the next two, move it to the transition from discrete to continuous descriptions with *coordinates* of a *vector space*
  - [1.5 Representing Types in Higher Dimensions with Coordinates]()
  - [1.6 Linear Transformations with Matrix-Vector Multiplication]()
  
in which then you will be prepared to understand the final two chapters which adds the technique of *recovering probabilities from data* to your toolbelt
in addition to *analytic probabilities*:
  - [1.7 Random Variables with their Distributions, Expectations, and Variance]()
  - [1.8 Probabilities from Data with Maximum Likelihood Estimation]()
...
starting with chapter [1.4 Representing Types Continuously with Vector Spaces]().
But for now, the next two chapters of
[1.2 Probabilities on Equally Likely Events with Elementary Combinatorics]()
and [1.3 Probabilities on Events with Rules: Sum Rule, Product Rule, Bayes Rule]()
...
<div class="full-bleed">
  <iframe height="750px" loading="lazy" src="https://www.youtube.com/embed/fNk_zzaMoSs?si=RM4DkmjjxivKNjN7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>

<div class="full-bleed-side">
  <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/k7RM-ot2NWY?si=GK0BOgsmchUV52Mx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
  <iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/TgKwz5Ikpc8?si=IA44m9h0QALa-YKR" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
You may have experience using (and in a data structure 
- new organonclass, implementing) francis bacon
- hume's problem of induction
- the bayesian solution (pierre simon laplace)
- the kolmogorov axiomatization of a probability space
...
### 1.6 Linear Transformations with Matrix-Vector Multiplication
<div class="full-bleed">
<iframe height="750px" loading="lazy" src="https://www.youtube.com/embed/kYB8IZa5AuE?si=GPQlzJ1uEg83PX8o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>

<div class="full-bleed-side">
<iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/Ip3X9LOh2dk?si=hIN4Lz7S0H6qR5z3" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
<iframe width="560" height="315" loading="lazy" src="https://www.youtube.com/embed/uQhTuRlWMxw?si=Jc-vZaoM-GlCm-XI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
## 2. Learning *Functions* From Data with `pytorch`
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small>
...
### 2.1 Linearly Modeling Regression by Directly Optimizing Squared Error Loss

loss vs likelihood?
(todo, r.v vs input space)?
...
so that $f$ is modeled as an inner product and determined by two parameters of vector $\mathbf{w} \in \reals^d$ and intercept $b$.

That is,
$$
\begin{aligned}
              f &:\reals^d \to \reals\\
f(\mathbf{x};\mathbf{w}) &\coloneqq \mathbf{w}^{\top}\mathbf{x} + b\\
                &= (\sum_{i=1}^{d} \mathbf{w}_i \mathbf{x}_i) + b\\
                &= (\mathbf{w}_1 \mathbf{x}_1 + \mathbf{w}_2 \mathbf{x}_2 + \cdots + \mathbf{w}_n \mathbf{x}_n) + b
\end{aligned}
$$

In which that final bias term $b$ can be folded into the vector $\mathbf{w}$ as $\mathbf{w}_1$,
...
Then, the equation of our line with bias simply becomes
$$
\begin{aligned}
              f &:\reals^{d+1} \to \reals\\
...
While specifying the equation of the linear regression model on ~~paper~~ screen
(and subsequently following with the manual computation of maximizing it's likelihood (todo or loss?))
might have been sufficient for pre-computational mathematicians such as Gauss and Legendre,
the discipline of statistical learning is predicated on computational methods.
We continue to use the n-dimensional array `torch.Tensor` from the Python package PyTorch:

```python
{{#include ../../examples/glm.py:1:4}}
```

which we can update the names of our `torch.Tensor` variables with the ranks of their vector
...
to make the operations less ambiguous.

```python
{{#include ../../examples/glm.py:5:8}}
```
...
```python
{{#include ../../examples/glm.py:9:19}}
```

The next step is to estimate the parameter $\mathbf{w}$ from the dataset $\mathcal{D}$ for the function $f$,
which just like a distribution, is the source of the function's "intelligence".
For now, we can sanity-check that we've wired everything correctly for `f_typechecked`
by evaluating it on every input in our dataset $\mathcal{D}$ with some random vector `w_D`.

```python
{{#include ../../examples/glm.py:21:32}}
```
...
Before we find such a parameter, we can make one more modification to our function $f$
...
Now that we've selected a model for the task $T$, the second step is to select the performance measure $P$.


### 2.2 Predicting Scalars with Linear Regression by Directly Optimizing Mean Squared Error
...
### 2.3 Predicting Categories with Logistic Regression By Iteratively Optimizing Cross Entropy Loss
...
## 3. Accelerating *Basic Linear Algebra Subroutines* with `teenygrad.Tensor`
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small>
