...
- [1. Representing *Data* with High Dimensional Stochasticity]()
  - [1.1 From Software 1.0 to 2.0: Propositionally Symbolic ELIZA to Probabilistically Dimensional GPT](#11-from-software-10-to-20-propositionally-symbolic-eliza-to-probabilistically-dimensional-gpt)
  ...
  - [1.5 Representing Data Dimensionally with Random Vectors of a Linear Coordinate Space](#15-representing-data-dimensionally-with-random-vectors-of-a-linear-coordinate-space)
...
- [3. Accelerating *Functions* and *Data* with Basic Linear Algebra Subroutines](#3-accelerating-functions-and-data-with-basic-linear-algebra-subroutines-in-teenygrad)
  ...
  - [3.1 Accelerating the BLAS: Instruction Sets, Processor Pipelines and Memory Hierarchies]()
  - [3.2 Accelerating Computation with Instruction Level Parallelism via Loop Unrolling]()
  - [3.3 Accelerating Computation with Data Level Parallelism via Vector/Matrix Extensions]()
  - [3.4 Accelerating Communication with Memory Hierarchies via Register and Cache Blocking]()
  - [3.5 Accelerating Computation with Thread Level Parallelism]()

## 1. Representing *Data* with High Dimensional Stochasticity in `torch`

### 1.1 From Software 1.0 to 2.0: Propositionally Symbolic ELIZA to Probabilistically Dimensional GPT
...
Recall Chapter 1's guiding question:
> Q: How do language models represent the **meaning of words?** </br>
...
Then, after understanding the second component to Chapter 1's guiding question,
...
- Linear Algebra (math defs): field R, points of a (vector) coordinate space R^n, linear transformation (matrices)
- torch
- Numerical Linear Algebra (): floating point,
- design matrices: independance, basis, dimension
