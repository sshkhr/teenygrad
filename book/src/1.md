...
- [1. Representing *Data* with High Dimensional Stochasticity]()
  - [1.1 From Propositionally Symbolic Software 1.0 to Probabilistically Dimensional Software 2.0](#11-from-software-10-to-20-propositionally-symbolic-eliza-to-probabilistically-dimensional-gpt)
...
- [3. Accelerating *Functions* and *Data* with Basic Linear Algebra Subroutines](#3-accelerating-functions-and-data-with-basic-linear-algebra-subroutines-in-teenygrad)
  ...
  - [3.3 Implementing Basic Linear Algebra Subroutines: `AXPY`, `GEMV` and `GEMM`]()
...
```python
{{#include ../../examples/1.4-word2vec.py}}
```
