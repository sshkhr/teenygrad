...
- [2. Learning *Functions* from *Data* with Parameter Estimation](#2-learning-functions-from-data-with-optimization-in-torch)
  - [**2.1 From Recovering Data to Recovering Functions**](#21-from-recovering-data-to-recovering-functions)
...
- [3. Accelerating *Functions* and *Data* with Basic Linear Algebra Subroutines](#3-accelerating-functions-and-data-with-basic-linear-algebra-subroutines-in-teenygrad)
  - [**3.1 From Abstract Linear Algebra to Numerical Linear Algebra**](#31-from-abstract-linear-algebra-to-numerical-linear-algebra)
...
```python
{{#include ../../examples/1.6-spaces.py:1:5}}
```

<span class="defnote">**data matrix $\mathbf{X}$**</span>**data matrix** $\mathbf{X}$

```python
{{#include ../../examples/1.6-spaces.py:5:53}}
```

```python
{{#include ../../examples/1.6-spaces.py:55:104}}
```
...
```python
{{#include ../../examples/1.6-spaces.py:112:}}
```
